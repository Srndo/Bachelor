...
extension DatabaseArchive {
    ...
    func fillWithData(encodedProto: String, local: Bool, recordID: String? = nil) -> Proto? {
        ...
        printError(from: "fillWithData", message: "Cannot decode encodedProto to Proto")
    ...
    func fillWithData(proto: Proto, local: Bool, recordID: String? = nil) -> String?{
    ...
    private func fill(proto: Proto, local: Bool, recordID: String?) {
